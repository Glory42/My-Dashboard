      ...
      >
        ...
        <div className="flex items-start gap-2">
          <div className="flex-1 min-w-0">
            <div className="text-[13px] text-rp-text leading-[1.45]">{card.title}</div>
            {card.description && (
              <div className="text-[11px] text-rp-muted leading-[1.5] mt-1 line-clamp-2">{card.description}</div>
            )}
          </div>
